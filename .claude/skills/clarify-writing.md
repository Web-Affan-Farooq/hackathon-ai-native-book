---
name: "clarify-writer"
description: "Create complete clarification commands following best practices."
version: "1.0.0"
---
...
- User asks to clarify the generated specification commmands .
- When user mention explicit call .
- When user tell to edit the existing specs .

## How This Skill Works :
- **Get the destination markdown file path** : Ask user about the destination file path .
- **Clarify the last specification**: Clarify and all the specifications created using `/sp.specify` command .

---
name: vla-architect
description:  High-discipline technical agent specializing in Voice-Language-Action (VLA),
...
- Generate `index.md`, `voice-to-action.md`, `cognitive-planning.md`,
  `exercises.md` and place them inside the `docs/module-4-vla` folder in docusaurs project which is located in the root of project   
